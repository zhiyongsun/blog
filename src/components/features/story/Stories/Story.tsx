  ...
  return (
    <Link href={`/posts/${slug}`}>
      <a className="select-none overflow-hidden w-full h-full vstack md:flex-row cursor-pointer focus:outline-2 ">
        {coverImage ? <div className="center w-full md:w-1/3 h-52 md:h-full bg-neutral-50 md:bg-transparent">
          <Image
            src={coverImage}
        ...
        <div className="md:w-2/3 p-2 md:p-3 vstack gap-2 bg-primary-1">
